            ...
            <?php if (is_user_logged_in()) : ?>
                ...
                <?php else : ?>
                    ...
                    <?php foreach ($comments as $comment => $c_val) { ?>
                        <div class=" comment container-fluid d-inline-flex align-items-center justify-content-between pe-0 mb-1 my-1 pt-0">
                            ...
                            <?php if (is_owner($c_val['username'])) : ?>
                                <button class="btn pic-btn comment-button p-0 border me-2">
