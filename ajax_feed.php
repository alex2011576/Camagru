            ...
            <?php if (is_user_logged_in()) : ?>
                ...
                <?php else : ?>
                    ...
                    <?php foreach ($comments as $comment => $c_val) { ?>
                        <div class=" comment container-fluid d-inline-flex align-items-center justify-content-between pe-0 mb-2 ">
                            ...
                            <?php if (is_owner($c_val['username'])) : ?>
                                <button class="btn pic-btn comment-button px-1 border me-1">
